...
torch.save(encoder.state_dict(),f'./trained-model/Encoder-D{DIM_MODEL}-H{NUM_HEAD}-DROPOUT{DROPOUT}.pth')
torch.save(decoder.state_dict(),f'./trained-model/Decoder-D{DIM_MODEL}-H{NUM_HEAD}-DROPOUT{DROPOUT}.pth')